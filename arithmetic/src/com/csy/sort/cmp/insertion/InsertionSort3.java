package com.csy.sort.cmp.insertion;
...
//	}
	...
	/**
	 * 将cur位置元素插入到insertIndex位置
	 * @param array
	 * @param cur
	 * @param insertIndex
	 */
	public void insert(int[] array, int begin, int insertIndex) {
		// 初始cur指针指向尾部待排序的第一个位置
		int cur = begin;
		// 先将待插入元素备份
		int ele = array[cur];
